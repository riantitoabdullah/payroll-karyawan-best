        ...
        <div class="container">
            <div class="site-navigation">
                ...
                <ul class="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right">
                    ...
                    <li><a href="./index.php" style="color: white;">Clock in</a></li>
                </ul>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="intro-wrap">
                        <h1 class="mb-5"><span class="d-block">Silahkan Absen </span> Pulang <span class="typed-words"></span></h1>

                        <div class="row">
                            <div class="col-12">
                                <form class="form" method="post" action="clockout.php">
                                    <div class="row mb-2">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-sm-12 col-md-6 mb-3 mb-lg-0 col-lg-4">
                                            <button type="submit" class="btn btn-primary btn-block" name="update">Update Absensi</button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
                                    ...
                                    $sql = "UPDATE absensi_karyawan SET jam_keluar='$jam_keluar' WHERE id_pegawai='$id_pegawai'";
                                    ...
                                    if (mysqli_query($connection, $sql)) {
                                        $is_success = true;
                                        $message = "Absensi pegawai dengan ID $id_pegawai berhasil diupdate.";
                                    } else {
